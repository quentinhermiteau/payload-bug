...
export async function up({ db }: MigrateUpArgs): Promise<void> {
  await db.execute(sql`
   CREATE TYPE "public"."enum_search_type" AS ENUM('page', 'press', 'realization', 'entity', 'foundation', 'group', 'refDocuments', 'jobs');
  ...
  ALTER TABLE "search" ADD COLUMN "extract" varchar;
  ALTER TABLE "search" ADD COLUMN "published_at" timestamp(3) with time zone;
  ALTER TABLE "search" ADD COLUMN "type" "enum_search_type";
  ALTER TABLE "search" DROP COLUMN IF EXISTS "meta_title";
  ALTER TABLE "search" DROP COLUMN IF EXISTS "meta_description";
  ALTER TABLE "search" DROP COLUMN IF EXISTS "meta_image_id";
...
export async function down({ db }: MigrateDownArgs): Promise<void> {
  ...
  ALTER TABLE "search" DROP COLUMN IF EXISTS "extract";
  ALTER TABLE "search" DROP COLUMN IF EXISTS "published_at";
